...
Revision ID: d685fe3f0b00
Revises:
Create Date: 2025-05-30 22:43:44.364763
...
def upgrade() -> None:
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text("timezone('UTC', now())"), nullable=False),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.CheckConstraint('filled >= 0', name=op.f('ck_orders_check_filled_non_negative')),
    sa.CheckConstraint('price > 0', name=op.f('ck_orders_check_price_positive')),
